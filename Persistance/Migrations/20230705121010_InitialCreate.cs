    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConsoleProducts", x => new { x.ConsoleId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_ConsoleProducts_Console_ConsoleId",
                        column: x => x.ConsoleId,
                        principalTable: "Console",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ConsoleProducts_Product_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Product",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "San Mateo", "USA", new DateTime(2023, 7, 5, 14, 10, 10, 403, DateTimeKind.Local).AddTicks(9965), "System", null, "", "94404", "California", "2207 Bridgepointe Pkwy", null, "" },
                    { 2, "San Mateo", "United States", new DateTime(2023, 7, 5, 14, 10, 10, 404, DateTimeKind.Local).AddTicks(15), "System", null, "", "94404", "California", "2207 Bridgepointe Pkwy", null, "" },
                    { 3, "Amsterdam", "The Netherlands", new DateTime(2023, 7, 5, 14, 10, 10, 404, DateTimeKind.Local).AddTicks(18), "System", null, "", "1012 RL", "", "Nieuwezijds Voorburgwal 225", null, "" },
                    { 4, "Bellevue", "United States", new DateTime(2023, 7, 5, 14, 10, 10, 404, DateTimeKind.Local).AddTicks(21), "System", null, "", "98004", "Washington", "500 108th Avenue North East Suite 2600", null, "" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, new DateTime(2023, 7, 5, 14, 10, 10, 404, DateTimeKind.Local).AddTicks(870), "System", null, "", null, 1, null, "", "Sony Interactive Entertainment", null, null, "Sony Interactive Entertainment", null, "", "https://sonyinteractive.com/en/" },
                    { 2, 2, new DateTime(2023, 7, 5, 14, 10, 10, 404, DateTimeKind.Local).AddTicks(875), "System", null, "", null, 2, null, "", "PlayStation Studios", 2, null, "PlayStation Studios", null, "", "https://www.playstation.com/en-us/corporate/playstation-studios/" },
                    { 3, 0, new DateTime(2023, 7, 5, 14, 10, 10, 404, DateTimeKind.Local).AddTicks(878), "System", null, "", null, 3, null, "", "Guerrilla", 2, null, "Guerrilla Games", null, "", "https://www.guerrilla-games.com/" },
                    { 4, 0, new DateTime(2023, 7, 5, 14, 10, 10, 404, DateTimeKind.Local).AddTicks(881), "System", null, "", null, 4, null, "", "Sucker Punch", 2, null, "Sucker Punch Productions", null, "", "https://www.suckerpunch.com/" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 7, 5, 14, 10, 10, 404, DateTimeKind.Local).AddTicks(370), "System", null, "", 1, "", "PlayStation®5 Console", 499.99m, new DateTime(2023, 7, 5, 14, 10, 10, 404, DateTimeKind.Local).AddTicks(367), new DateTime(2020, 11, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, "", "https://direct.playstation.com/en-us/buy-consoles/playstation5-console/" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConsoleProducts_ProductId",
                table: "ConsoleProducts",
                column: "ProductId");
